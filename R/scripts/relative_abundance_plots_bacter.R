...
ps_plot_bar(
  ...
  taxrank = "Phylum",
  top = 10, 
  title="Bacteria: Top 10 Phyla per country (averaged)",
  xlab.rel = 0.8 
) 
...
ps_plot_bar(
  ...
  taxrank = "Class",
  top = 14, 
  title="Bacteria: Top 14 Class per country (averaged)",
  xlab.rel = 0.8 
) 
...
ps_plot_bar(
  ...
  taxrank = "Order",
  top = 30, 
  title="Bacteria: Top 30 Order per country (averaged)",
  xlab.rel = 0.8 
) +
...
ps_plot_bar(
  ...
  taxrank = "Family",
  top = 30, 
  title="Bacteria: Top 30 Family per country (averaged)",
  xlab.rel = 0.8 
) +
  theme(legend.key.size = unit(0.4, 'cm'))
...
ps_plot_bar(
  ...
  taxrank = "Genus",
  top = 35, 
  title="Bacteria: Top 35 Genus per country (averaged)",
  xlab.rel = 0.8 
) +
  theme(legend.key.size = unit(0.4, 'cm'))
